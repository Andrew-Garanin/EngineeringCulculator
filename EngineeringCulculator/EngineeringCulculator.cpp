...
// EngineeringCulculator.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CEngineeringCulculatorApp, CWinApp)
...
CEngineeringCulculatorApp::CEngineeringCulculatorApp() noexcept
{
	...
	SetAppID(_T("EngineeringCulculator.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CEngineeringCulculatorApp

CEngineeringCulculatorApp theApp;
...
BOOL CEngineeringCulculatorApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CEngineeringCulculatorDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CEngineeringCulculatorView));
	if (!pDocTemplate)
		return FALSE;
...
// Обработчики сообщений CEngineeringCulculatorApp
...
void CEngineeringCulculatorApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
